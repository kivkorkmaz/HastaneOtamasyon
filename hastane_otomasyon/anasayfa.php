...
<form action="islem.php" method="post">
    ...
    <select name="hastane" class="hastane">
        ...
        <option value="Malatya Devlet Hastanesi">Malatya Devlet Hastanesi</option>
        <option value="Fatih Terim Hastanesi">Fatih Terim Hastanesi</option>
    ...
    <select name="doktor" class="doktor">
        ...
        <option value="Burak Fedakar">Burak Fedakar</option>
        ...
        <option value="Ali Kaplan">Ali Kaplan</option>
        <option value="Doç Dr Fatih Terim">Doç Dr Fatih Terim</option>


    </select>
    <input type="hidden" name="kullanici_id" value="<?php echo $kullanicicek['kullanici_id']; ?>">
    <button style="color: red; background: whitesmoke;" name="randevu_kaydet">Randevu Kaydet</button>
...
<div class="orta_div" id="ailehekimi_div">
    <h3 style="color: black; background: whitesmoke">Aile Hekimi</h3>
    <p style="color: red; background: whitesmoke">
        Aile Hekiminiz Kıvanç Korkmaz
    </p>
